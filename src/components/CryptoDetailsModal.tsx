...
const HighLowIndicator = ({
  ...
  high,
  low,
}: HighLowIndicatorPropsType) => {
  const [green, setGreen] = useState<number>(0);

  //* Calculate the green zone
  useEffect(() => {
        ...
        {coinData ? (
          <div className="flex md:flex-row flex-col items-center justify-between lg:h-full h-auto w-full p-4 relative">
            <div className="flex flex-col md:w-[45%] w-full h-full pr-2">
                ...
                <div className="flex flex-col w-full">
                  ...
                  <h2 className="text-lg font-bold">
                    {new Intl.NumberFormat("en-IN", {
                      ...
                      coinData.market_data.current_price[currency as string]
                    )}
                  </h2>
                </div>
              </div>
                ...
                <div className="flex flex-col">
                  ...
                  <h2 className="text-base font-bold">
                    {new Intl.NumberFormat("en-IN", {
                      ...
                      coinData.market_data.market_cap[currency as string]
                    )}
                  </h2>
                </div>
              ...
              <div className="flex flex-col w-full mt-4 justify-between">
                ...
                <h2 className="text-base font-bold">
                  {new Intl.NumberFormat("en-IN", {
                    ...
                    coinData.market_data.total_volume[currency as string]
                  )}
                </h2>
              </div>
              ...
              <div className="flex w-full mt-4 justify-between">
                <HighLowIndicator
                  ...
                  high={coinData.market_data.high_24h[currency as string]}
                  low={coinData.market_data.low_24h[currency as string]}
                />
              </div>
              ...
              <div className="flex w-full mt-4 justify-between">
                <div className="flex flex-col">
                  ...
                  <h2 className="text-base font-bold">
                    ...
                    }).format(coinData.market_data.low_24h[currency as string])}
                  </h2>
                </div>
                <div className="flex flex-col">
                  <span className="text-sm capitalize text-gray-100">
                  ...
                  <h2 className="text-base font-bold">
                    {new Intl.NumberFormat("en-IN", {
                      ...
                      coinData.market_data.high_24h[currency as string]
                    )}
                  </h2>
                </div>
              </div>
            ...
            <div className="flex flex-col md:w-[55%] w-full h-[60vh] md:pl-4 pl-0 md:mt-0 mt-2">
              ...
              <div className="flex flex-col md:mt-4 mt-10">
