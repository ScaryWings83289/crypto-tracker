...
const CryptoTable = () => {
  ...
  return (
    <div className="flex flex-col mt-20 border border-gray-100 rounded">
      {cryptoData.length > 0 ? (
            ...
            {cryptoData.map((coin: CoinsDataType) => (
              ...
              >
                <td className="py-4 flex items-center uppercase">
                  <button className="flex align-middle items-center outline-0 border-o bg-none cursor-pointer">
                    <svg
                ...
                <td
                  className={`${
                    (coin.price_change_percentage_1h_in_currency as number) > 0
                      ? "text-green"
                      : "text-red"
                  } py-4`}
                >
                ...
                <td
                  className={`${
                    (coin.price_change_percentage_24h_in_currency as number) > 0
                      ? "text-green"
                      : "text-red"
                  } py-4`}
                >
                ...
                <td
                  className={`${
                    (coin.price_change_percentage_7d_in_currency as number) > 0
                      ? "text-green"
                      : "text-red"
                  } py-4`}
                >
